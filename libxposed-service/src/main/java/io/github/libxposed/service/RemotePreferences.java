...
public final class RemotePreferences implements SharedPreferences {
    ...
    static RemotePreferences newInstance(XposedService service, String group) throws RemoteException {
        ...
        // getSerializable(String) is deprecated since API 33 (Tiramisu) in favour of the typed
        // getSerializable(String, Class); fall back to the old form on older devices (minSdk 27).
        @SuppressWarnings({"unchecked", "deprecation"}) // old-device fallback keeps the deprecated call
        Map<String, Object> map =
                android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.TIRAMISU
                        ? (Map<String, Object>) output.getSerializable("map", HashMap.class)
                        : (Map<String, Object>) output.getSerializable("map");
