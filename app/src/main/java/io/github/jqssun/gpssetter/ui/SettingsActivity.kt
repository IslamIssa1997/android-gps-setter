...
class ActivitySettings : AppCompatActivity() {
    ...
    class SettingPreferenceDataStore : PreferenceDataStore() {
        ...
        override fun getBoolean(key: String?, defValue: Boolean): Boolean = when (key) {
            ...
            "spoof_all_scoped" -> PrefManager.spoofAllScoped
            else -> defValue
        }
        ...
        override fun putBoolean(key: String?, value: Boolean) {
            when (key) {
                ...
                "spoof_all_scoped" -> PrefManager.spoofAllScoped = value
            }
        }
    ...
    class SettingsPreferenceFragment : PreferenceFragmentCompat() {
        ...
        override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
            ...
            // Delete/reorder saved locations. Lives in its own screen so the map favourites dialog
            // stays a simple picker.
            findPreference<Preference>("favorites_edit")?.setOnPreferenceClickListener {
                startActivity(Intent(requireContext(), FavoritesEditActivity::class.java))
                true
            }
